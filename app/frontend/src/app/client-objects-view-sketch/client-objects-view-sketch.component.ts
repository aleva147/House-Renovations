...
@Component({
  selector: 'app-client-objects-view-sketch',
  templateUrl: './client-objects-view-sketch.component.html',
  styleUrls: ['./client-objects-view-sketch.component.css']
})
export class ClientObjectsViewSketchComponent implements OnInit {
