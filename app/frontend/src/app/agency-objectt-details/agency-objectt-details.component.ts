...
@Component({
  selector: 'app-agency-objectt-details',
  templateUrl: './agency-objectt-details.component.html',
  styleUrls: ['./agency-objectt-details.component.css']
})
export class AgencyObjecttDetailsComponent implements OnInit {
