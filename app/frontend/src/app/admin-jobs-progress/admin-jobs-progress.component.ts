...
@Component({
  selector: 'app-admin-jobs-progress',
  templateUrl: './admin-jobs-progress.component.html',
  styleUrls: ['./admin-jobs-progress.component.css']
})
export class AdminJobsProgressComponent implements OnInit {
